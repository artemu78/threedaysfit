  ...
  },
  {
    ...
    exercises: [
      ...
      },
      {
        ...
        primaryMuscles: "Back / Wing, Chest",
        sets: 4,
        reps: "10-12",
        rest: "90s",
        imageAlt: "Barbell Pullover exercise demonstration",
        instructions: [
          "Lie on a flat bench, barbell over chest with elbows slightly bent.",
          "Inhale, brace core, and lower the barbell in an arc behind your head until you feel a stretch in lats and chest.",
          "Exhale, pull it back over chest using lats and chest. ",
          "Keep arms mostly straight and control the movement throughout.",
        ],
        image: "./images/day2/Barbell-Bent-Arm-Pullover.gif",
        details: "https://fitnessprogramer.com/exercise/barbell-pullover/",
      },
      {
        id: 9,
        name: "Deadlift",
        primaryMuscles: "Back / Wing, Erector Spinae",
        secondaryMuscles: "Hip, Leg",
        sets: 4,
        reps: "8-10",
        rest: "90s",
        imageAlt: "Deadlift exercise demonstration",
        instructions: [
          "Stand with your feet shoulder-width apart, toes pointed straight ahead.",
          "Grasp the bar slightly wider than shoulder-width with an overhand or mixed grip.",
          "Bend your knees, lower your hips, keep your back straight, chest up, and head neutral.",
          "Take a deep breath and brace your core to stabilize your spine.",
          "Lift the bar close to your body using legs, glutes, and back muscles.",
          "At the top, pause briefly, then lower the bar with your back straight and core engaged.",
        ],
        image: "./images/day2/Barbell-Deadlift.gif",
        details: "https://fitnessprogramer.com/exercise/deadlift/",
      },
      {
        id: 7,
